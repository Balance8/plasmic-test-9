...
import * as sty from "./PlasmicActionButton.module.css"; // plasmic-import: _9YrkpjGXJEK5/css
...
function PlasmicActionButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div
        className={classNames(defaultcss.all, sty.box__mQa16, {
          [sty.box__options_large__mQa161P8F]: hasVariant(
            variants,
            "options",
            "large"
          ),
          [sty.box__options_medium__mQa16QhMMf]: hasVariant(
            variants,
            "options",
            "medium"
          )
      ...
      >
        {(triggers.hover_root ? true : true) ? (
          <div
            className={classNames(defaultcss.all, sty.box__aYKo, {
              [sty.box__options_labeled__aYKoTbg7T]: hasVariant(
                variants,
                "options",
                "labeled"
              ),
              [sty.box__options_medium__aYKoQhMMf]: hasVariant(
                variants,
                "options",
                "medium"
              )
