...
import * as sty from "./PlasmicTrend.module.css"; // plasmic-import: 7DZSrmqrTbCqfP/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.box__z6Ixr)}
      >
        <p.PlasmicSlot
      ...
      <div className={classNames(defaultcss.all, sty.box__qhKIz)}>
        <div className={classNames(defaultcss.all, sty.box__hixwz)}>
          <p.PlasmicSlot
            defaultContents={
